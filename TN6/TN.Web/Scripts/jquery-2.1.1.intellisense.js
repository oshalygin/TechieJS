...
intellisense.redirecddefinition(jQuery.Callbacks, _1228819969);
...
intellisense.redirecddefinition(jQuery.Callbacks, _731531622);
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'isDefaultPrevented': function() {
    /// <summary>Returns whether event.prevenddefault() was ever called on this event object.</summary>
    /// <returns type="Boolean" />
  },
...
intellisense.annotate(jQuery.fn, {
  ...
  'bind': function() {
    ...
    ///   <param name="evenddata" type="Object">An object containing data that will be passed to the event handler.</param>
  ...
  'keydown': function() {
    ...
    /// <signature>
    ///   <summary>Bind an event handler to the "keydown" JavaScript event, or trigger that event on an element.</summary>
    ///   <param name="evenddata" type="PlainObject">An object containing data that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'unload': function() {
    ...
    /// <signature>
    ///   <summary>Bind an event handler to the "unload" JavaScript event.</summary>
    ///   <param name="evenddata" type="Object">A plain object of data that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
