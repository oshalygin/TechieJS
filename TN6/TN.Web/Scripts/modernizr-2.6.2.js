...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // TODO :: add tesddOMProps
    /**
     * tesddOMProps is a generic DOM property test; if a browser supports
     *   a certain property, it won't return undefined for it.
     */
    function tesddOMProps( props, obj, elem ) {
        for ( var i in props ) {
    ...
    function testPropsAll( prop, prefixed, elem ) {
        ...
        // otherwise, they called .prefixed('requestAnimationFrame', window[, elem])
          ...
          return tesddOMProps(props, prefixed, elem);
        }
    }
    /*>>testallprops*/
    ...
    /*jshint evil:true */
      ...
      var saveClones = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|dd|th|tr|ul)$/i;
