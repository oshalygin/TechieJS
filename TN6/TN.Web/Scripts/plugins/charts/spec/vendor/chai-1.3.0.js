!function (name, context, definition) {
  ...
  require.register("chai/interface/assert.js", function(module, exports, require){
    ...
    module.exports = function (chai, util) {
      ...
      /**
       * ### .noddeepEqual(actual, expected, [message])
       *
       * Assert that `actual` is not deeply equal to `expected`.
       *
       *     assert.noddeepEqual({ tea: 'green' }, { tea: 'jasmine' });
       *
       * @name noddeepEqual
       * @param {Mixed} actual
       * @param {Mixed} expected
      ...
      assert.noddeepEqual = function (act, exp, msg) {
      ...
      /**
       * ### .noddeepProperty(object, property, [message])
       *
       * Asserts that `object` does _not_ have a property named by `property`, which
       * can be a string using dot- and bracket-notation for deep reference.
       *
       *     assert.noddeepProperty({ tea: { green: 'matcha' }}, 'tea.oolong');
       *
       * @name noddeepProperty
       * @param {Object} object
       * @param {String} property
       * @param {String} message
       * @api public
      ...
      assert.noddeepProperty = function (obj, prop, msg) {
